Ext.define('library.view.main.LibraryHome', {
	...
	items:[
			...
			items:[
				{
					...
					height:'83%',
					items: [
						{xtype: 'container',width:'75%',height:'100%',margin:'0',padding:'0 12 0 12',
						 autoScroll: true,
						 scrollable: true,
			...
			items:[
				{
					...
					height:'83%',
					items:[{
						xtype: 'container',width:'75%',height:'100%',margin:'0',padding:'0 18 0 12',
						scrollable: true,
						autoScroll: true,
		...
		},
		{
			title: "Scriptures",
			items:[{
				xtype: 'menuscriptcategoryresult',width:'100%',margin:'0',padding:'0 12 0 12',
				layout: {type: 'hbox',align:'fit'},
				shrinkWrap:false,
				flex:1,
				width:'100%',
		...
		},
		{
			title: 'Books',
			items:[{
				xtype:'bookresult',width:'100%',margin:'0',padding:'0 18 0 12',
				layout: {type: 'hbox',align:'fit'},
				shrinkWrap:false,
				flex:1,
				width:'100%',
			...
			items:[
				{
					...
					height:'98%',
					items:[{
						xtype:'searchresult',width:'100%',margin:'0',padding:'0 12 0 12'
					}]
				}
			]
		},
	...
	listeners:
	{
		added:{
			fn:function(t , container , index , eopts){
				//t.getTabBar().setStyle("border:1px solid gray;font-size:14px;color:#000;");
			}
		}
	}
});
