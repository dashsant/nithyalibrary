	...
	items:[
		{
			...
			html: 'Paramahamsa Nithyananda is revered, regarded, respected and worshipped as The Avatar (living incarnation as per Hinduism) of super-consciousness by millions across the globe. He is the spiritual head of the Mahanirvani Peetha, oldest and largest apex body of Hinduism, and three time Guinness World Records® record holder. He and his Sangha (spiritual community) around the globe are serving humanity by reviving the Science of Completion℠, Science of Enlightenment℠ and manifesting various extraordinary spiritual powers as per the Vedic Agamic tradition of Sanatana Hindu Dharma. He is the author of 300 books, which are translated and published in 500 titles and various international languages. His Sangha has a strong presence worldwide through numerous Temples, Adheenams (Temple monastery complex), Gurukuls (Vedic schools), universities, goshalas (cow shelters). His live Satsangs (spiritual discourses) are viewed every morning (8pm IST) by people from all countries around the world.',
			padding: 15
		},
		{
			...
			items:[
				{
					xtype:'container',
					width: '95%',
					html:'<div style="height:80%;min-height:80%;overflow:auto;max-height:100%;"><h1>Vedagamas – The Complete Process for Completion & Enlightenment</h1><br>'+
